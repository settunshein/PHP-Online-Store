<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <form method="POST" enctype="multipart/form-data" id="createMovieForm"> 
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="card-custom-title">Create Movie Form</span>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="price" id="price" type="number" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="rating" id="rating" type="text" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="casts" id="casts" type="text" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="trailer" id="trailer" type="text" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="synopsis" id="synopsis" cols="30" rows="8" class="form-control form-control-sm"></textarea>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <div class="card">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-sm btn-outline-dark rounded-0 float-right" type="submit" name="insert_movie">
